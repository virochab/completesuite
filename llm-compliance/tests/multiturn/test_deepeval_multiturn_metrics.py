...
METRIC_THRESHOLD_MAP = {
    "Turn Relevancy": ("deepeval", "multiturn", "turn_relevancy_min"),
    "Role Adherence": ("deepeval", "multiturn", "role_adherence_min"),
    "Conversation Completeness": ("deepeval", "multiturn", "conversation_completeness_min"),
    "Goal Accuracy": ("deepeval", "multiturn", "goal_accuracy_min"),
...
def get_metric_model(thresholds, metric_name):
    ...
    model_map = {
        "Turn Relevancy": ("deepeval", "multiturn", "turn_relevancy_model"),
        "Role Adherence": ("deepeval", "multiturn", "role_adherence_model"),
        "Conversation Completeness": ("deepeval", "multiturn", "conversation_completeness_model"),
        "Goal Accuracy": ("deepeval", "multiturn", "goal_accuracy_model"),
