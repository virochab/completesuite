...
from newTWIAapp import PDFRAGAgent
...
app = FastAPI(
    title="TWIA RAG Agent API",
    description="API for querying TWIA documents using RAG (Retrieval Augmented Generation)",
    version="1.0.0"
)
...
VECTOR_DB_PATH = os.getenv("VECTOR_DB_PATH", os.path.join(parent_dir, "vectorInsurancedb"))
